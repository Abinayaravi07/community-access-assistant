...
import { AgeRange, BenefitType, CasteCategory, ComparisonOperator, CriterionType, EducationLevel, Gender, GovernmentLevel, IncomeLevel, MaritalStatus, OccupationType, RelationshipType, ResidenceType, SupportedLanguage } from '../types/enums';
/**
 * Generate a random enum value
 */
function arbEnum(enumObj) {
 ...
 */
export const arbLocationInfo = fc.record({
    state: fc.constantFrom('Maharashtra', 'Karnataka', 'Tamil Nadu', 'Gujarat', 'Rajasthan', 'Uttar Pradesh', 'West Bengal', 'Madhya Pradesh', 'Kerala', 'Delhi'),
 ...
 */
export const arbFamilyMember = fc.record({
    id: arbId,
 ...
 */
export const arbDataSource = fc.record({
 ...
 */
export const arbContactInfo = fc.record({
 ...
 */
export const arbRequiredDocument = fc.record({
    name: fc.string({ minLength: 3, maxLength: 50 }),
    description: fc.string({ minLength: 10, maxLength: 200 }),
    isMandatory: fc.boolean(),
    alternativeDocuments: fc.option(fc.array(fc.string({ minLength: 3, maxLength: 50 }), { maxLength: 3 }), { nil: undefined })
});
/**
 * Generate a random ApplicationStep
 */
export const arbApplicationStep = fc.record({
 ...
 */
export const arbEligibilityCriterion = fc.record({
    id: arbId,
    ...
    value: fc.oneof(fc.integer({ min: 0, max: 100 }), fc.string({ minLength: 2, maxLength: 20 }), fc.array(fc.string({ minLength: 2, maxLength: 20 }), { maxLength: 5 })),
    description: fc.string({ minLength: 10, maxLength: 200 }),
    isMandatory: fc.boolean()
});
/**
 ...
 */
export const arbBenefitDetails = fc.record({
 ...
 */
export const arbGovernmentScheme = fc.record({
    id: arbId,
